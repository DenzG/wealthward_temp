import{cS as A,cV as D,cB as $,cK as h,cW as u,cI as V,cC as N,c_ as S,cD as M,dg as K,d1 as F,d2 as Q,cT as W,cU as q}from"./index-mHwtQ-V1.js";import{r as l,n as w,c as C}from"./index-DrI4JZwu.js";import"./index-BFE27R9R.js";import"./index-C0ixAcZH.js";import"./index-Cnx_OUct.js";import{S as s}from"./SwapController-DAlu157b.js";import"./index-Bn3NANHl.js";import"./index-T2HkZ2yf.js";import{M as _}from"./MathUtil-BGCe3rZ3.js";import"./index-DVPyH13d.js";import"./index-BNtrf7mT.js";import"./index-D9uydRjC.js";import"./if-defined-DM48da-R.js";import"./ref-D0g9Xwcl.js";const H={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",L=a==="x",E=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||L)&&e.preventDefault(),t==="0"&&!E&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(E||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!E&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
...
`;var U=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let P=class extends D{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var o;if(!this.visible)return null;const t=this.amount&&this.price?(o=h.multiply(this.price,this.amount))==null?void 0:o.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};P.styles=[W,q,oe];U([w()],P.prototype,"imageSrc",void 0);U([w()],P.prototype,"name",void 0);U([w()],P.prototype,"symbol",void 0);U([w()],P.prototype,"price",void 0);U([w()],P.prototype,"amount",void 0);U([l()],P.prototype,"visible",void 0);U([l()],P.prototype,"imageError",void 0);P=U([C("wui-token-list-item")],P);const ie=A`
  :host {
    width: 100%;
  }
